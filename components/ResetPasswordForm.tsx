            ...
            <form ref={formRef} className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <input
                    className="w-full px-4 py-3 bg-white border border-[#c7c4d7] rounded-lg focus:outline-none focus:ring-4 focus:ring-[#4648d4]/20 focus:border-[#4648d4] transition-all text-base"
                    id="current_password"
