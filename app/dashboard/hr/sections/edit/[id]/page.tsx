...
export default function EditSectionPage() {
  ...
  const [defaultValues, setDefaultValues] = useState<{ sectionCode: string; sectionName: string; departmentId: string } | undefined>();
  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        ...
        toast.error("ไม่สามารถโหลดข้อมูลส่วนงานได้");
        router.push("/dashboard/hr/sections");
      } finally {
        setLoading(false);
      }
    }
            ...
            <div className="bg-[#1a1a40] text-white p-6 rounded-t-2xl">
              <div className="flex items-center justify-between gap-3">
                <div className="flex gap-3">
                  ...
                  <h2 className="text-xl font-medium tracking-wide">แก้ไขส่วนงาน</h2>
                </div>
                <div className="">
                  <Button
                    variant="ghost"
