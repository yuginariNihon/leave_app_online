      ...
      <main className="flex-1 overflow-y-auto">
        <section className="flex-1 px-4 md:px-10 py-8 md:py-12 bg-[#F8FAFC]">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-[#1a1a40] text-white p-6 rounded-t-2xl">
              <div className="flex items-center justify-between gap-3">
                <div className="flex gap-3">
                  ...
                  <h2 className="text-xl font-medium tracking-wide">แก้ไขลำดับการอนุมัติ — {positionName}</h2>
                </div>
                <div className="">
                  <Button
                    variant="ghost"
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <select
                        ...
                        onChange={(e) =>
                          handleChange(step.key, "approverType", e.target.value)
                        }
                    ...
                    <label className="flex items-center gap-2 text-sm text-slate-600 cursor-pointer whitespace-nowrap">
                      <input
                        ...
                        onChange={(e) =>
                          handleChange(step.key, "isRequired", e.target.checked)
                        }
            ...
            <HelpSection mode="edit" entityName="ลำดับการอนุมัติ" />
          </div>
        </section>
      </main>
    </div>
