...
export default function EditDepartmentPage() {
  ...
  const [defaultValues, setDefaultValues] = useState<{ departmentCode: string; departmentName: string } | undefined>();
            ...
            <div className="bg-[#1a1a40] text-white p-6 rounded-t-2xl">
              <div className="flex items-center justify-between gap-3">
                <div className="flex gap-3">
                  ...
                  <h2 className="text-xl font-medium tracking-wide">แก้ไขแผนก</h2>
                </div>
                <div className="">
                  <Button
                    variant="ghost"
